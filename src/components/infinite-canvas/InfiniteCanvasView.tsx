...
import { Infinity, Plus, Search } from 'lucide-react'
    ...
    <div className="flex h-full bg-gray-50">
      <div className="flex-1 flex items-center justify-center">
        <div className="text-center max-w-md">
          <Infinity className="w-16 h-16 mx-auto mb-4 text-gray-300" />
          <h2 className="text-xl font-semibold text-gray-900 mb-2">无限画布</h2>
          <p className="text-gray-600 mb-6">
            创意思维导图工具，在无限画布上自由创作和组织想法
          </p>
